    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 md:px-8 md:-mt-16 md:-mt-20">
        <div class="bg-white rounded-xl shadow-2xl px-6 py-8 md:py-10 border border-gray-100">
            <form class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <!-- Property Type -->
                <div class="relative">
                    <select class="w-full appearance-none px-4 py-3 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-400 focus:border-transparent">
                ...
                <!-- Search Button -->
                <button type="submit"
                    class="w-full bg-[#449EC2] hover:bg-sky-800 text-white font-semibold py-3 rounded-md transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-xl shadow hover:shadow-lg transition overflow-hidden">
                        <div class="relative">
                            ...
                            <span
                                class="absolute top-3 left-3 bg-[#449EC2] text-white text-xs font-semibold p-3 rounded shadow">For Buy</span>
                            <span
                                class="absolute bottom-3 left-3 bg-white text-sky-700 text-xs font-semibold p-3 rounded shadow">Apartment</span>
                        </div>
                        <div class="p-5">
                            ...
                            <p class="flex items-center text-sm text-gray-500 mb-4">
                                <span class="material-symbols-outlined text-sky-600 mr-1">location_on</span>123 Street,
                                New York, USA
                            </p>
            ...
            <div class="flex flex-col md:flex-row gap-8">
               ...
               <div class="w-full md:w-4/5 ">
                  ...
                  <div class=" my-6 bg-gradient-to-r from-sky-400 to-sky-700 text-white px-6 py-4 rounded-xl shadow-lg flex items-center justify-between">
                    <div>
                        <span class="inline-block bg-yellow-500 text-sky-900 text-xs font-bold px-2 py-1 rounded uppercase mr-2">Premium</span>

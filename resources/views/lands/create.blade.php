...
<x-app-layout>
    ...
    <div class="mt-10 md:px-32">
        <div class="flex items-center justify-between mb-6">
            <h3 class="text-2xl font-bold text-gray-800">Add Land</h3>
        ...
        <form action="{{ route('lands.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow rounded-lg p-6 space-y-8">
            @csrf
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input name="title" type="text" value="{{ old('title') }}" required class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Slug (auto if empty)</label>
                        <input name="slug" type="text" value="{{ old('slug') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Reference Code</label>
                        <input name="reference_code" type="text" value="{{ old('reference_code') }}" class="border p-2 rounded w-full">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="listing_type" class="border p-2 rounded w-full">
                            @foreach(['sale','rent','lease'] as $opt)
                                <option value="{{ $opt }}" @selected(old('listing_type')==$opt)>{{ ucfirst($opt) }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
...
{{--                    </div>--}}
                    ...
                    <div class="md:col-span-3">
                        ...
                        <textarea name="description" rows="4" class="border p-2 rounded w-full">{{ old('description') }}</textarea>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input name="price" type="number" step="0.01" value="{{ old('price') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Currency</label>
                        <input name="currency" type="text" value="{{ old('currency','INR') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        ...
                        <select name="price_unit" class="border p-2 rounded w-full">
                            @foreach(['total','per_sqft','per_sqyd','per_sqmt','per_acre','per_bigha','per_hectare'] as $opt)
                                <option value="{{ $opt }}" @selected(old('price_unit')==$opt)>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="flex items-end">
                        <label class="inline-flex items-center gap-2">
                            <input name="is_negotiable" type="checkbox" value="1" @checked(old('is_negotiable')) class="rounded border-gray-300">
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                    <div>
                        ...
                        <input name="area_value" type="number" step="0.01" value="{{ old('area_value') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        ...
                        <select name="area_unit" class="border p-2 rounded w-full">
                            @foreach(['sqft','sqyd','sqmt','acre','hectare','bigha','guntha','cent','marla','biswa','katha'] as $opt)
                                <option value="{{ $opt }}" @selected(old('area_unit')==$opt)>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Plot Length</label>
                        <input name="plot_length" type="number" step="0.01" value="{{ old('plot_length') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Plot Breadth</label>
                        <input name="plot_breadth" type="number" step="0.01" value="{{ old('plot_breadth') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        ...
                        <select name="dimensions_unit" class="border p-2 rounded w-full">
                            @foreach(['ft','yd','m'] as $opt)
                                <option value="{{ $opt }}" @selected(old('dimensions_unit')==$opt)>{{ strtoupper($opt) }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Frontage</label>
                        <input name="frontage" type="number" step="0.01" value="{{ old('frontage') }}" class="border p-2 rounded w-full" placeholder="e.g., road frontage">
                    </div>

                    <div>
                        <label class="block text-sm font-medium">Road Width</label>
                        <input name="road_width" type="number" step="0.01" value="{{ old('road_width') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        ...
                        <select name="road_unit" class="border p-2 rounded w-full">
                            @foreach(['ft','m','yd'] as $opt)
                                <option value="{{ $opt }}" @selected(old('road_unit')==$opt)>{{ strtoupper($opt) }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="flex items-end">
                        <label class="inline-flex items-center gap-2">
                            <input name="corner_plot" type="checkbox" value="1" @checked(old('corner_plot')) class="rounded border-gray-300">
                    ...
                    <div>
                        ...
                        <select name="facing" class="border p-2 rounded w-full">
                            ...
                            @foreach(['N','NE','E','SE','S','SW','W','NW'] as $opt)
                                <option value="{{ $opt }}" @selected(old('facing')==$opt)>{{ $opt }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="shape" class="border p-2 rounded w-full">
                            ...
                            @foreach(['rectangular','square','irregular','trapezium','triangular','other'] as $opt)
                                <option value="{{ $opt }}" @selected(old('shape')==$opt)>{{ ucfirst($opt) }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <select name="land_use" class="border p-2 rounded w-full">
                            ...
                            @foreach(['residential','commercial','agricultural','industrial','mixed','institutional','warehouse'] as $opt)
                                <option value="{{ $opt }}" @selected(old('land_use')==$opt)>{{ ucfirst($opt) }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Zoning</label>
                        <input name="zoning" type="text" value="{{ old('zoning') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">FSI / FAR</label>
                        <input name="fsi" type="number" step="0.01" value="{{ old('fsi') }}" class="border p-2 rounded w-full">
                    </div>
                </div>
            </section>
                    ...
                    <div>
                        ...
                        <select name="ownership" class="border p-2 rounded w-full">
                            ...
                            @foreach(['freehold','leasehold','power_of_attorney','cooperative','company','other'] as $opt)
                                <option value="{{ $opt }}" @selected(old('ownership')==$opt)>{{ ucwords(str_replace('_',' ',$opt)) }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Tenure (years)</label>
                        <input name="tenure_years" type="number" value="{{ old('tenure_years') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">RERA ID</label>
                        <input name="rera_id" type="text" value="{{ old('rera_id') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Survey No.</label>
                        <input name="survey_number" type="text" value="{{ old('survey_number') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Khasra No.</label>
                        <input name="khasra_number" type="text" value="{{ old('khasra_number') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Plot No.</label>
                        <input name="plot_number" type="text" value="{{ old('plot_number') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Khata No.</label>
                        <input name="khata_number" type="text" value="{{ old('khata_number') }}" class="border p-2 rounded w-full">
                    </div>

                    <div class="flex items-end">
                        <label class="inline-flex items-center gap-2">
                            <input name="is_non_agricultural" type="checkbox" value="1" @checked(old('is_non_agricultural')) class="rounded border-gray-300">
                            <span class="text-sm">Non-Agricultural (NA) converted</span>
                        </label>
                    </div>
                    <div class="flex items-end">
                        <label class="inline-flex items-center gap-2">
                            <input name="title_clear" type="checkbox" value="1" @checked(old('title_clear', true)) class="rounded border-gray-300">
                            <span class="text-sm">Title Clear</span>
                        </label>
                    </div>
                    <div class="flex items-end">
                        <label class="inline-flex items-center gap-2">
                            <input name="loan_available" type="checkbox" value="1" @checked(old('loan_available')) class="rounded border-gray-300">
                            <span class="text-sm">Loan Available</span>
                        </label>
                    </div>
                    <div class="md:col-span-3">
                        <label class="block text-sm font-medium">Encumbrances / Notes</label>
                        <textarea name="encumbrances" rows="3" class="border p-2 rounded w-full">{{ old('encumbrances') }}</textarea>
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
                    ...
                    @foreach($utils as $name => $label)
                        <label class="inline-flex items-center gap-2">
                            <input type="checkbox" name="{{ $name }}" value="1" @checked(old($name)) class="rounded border-gray-300">
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input name="documents[]" type="text" value="{{ old('documents.0') }}" class="border p-2 rounded w-full mb-2" placeholder="https://...">
                        <input name="documents[]" type="text" value="{{ old('documents.1') }}" class="border p-2 rounded w-full mb-2" placeholder="https://...">
                        <input name="documents[]" type="text" value="{{ old('documents.2') }}" class="border p-2 rounded w-full" placeholder="https://...">
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="md:col-span-3">
                        ...
                        <input name="address_line" type="text" value="{{ old('address_line') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Landmark</label>
                        <input name="landmark" type="text" value="{{ old('landmark') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Locality</label>
                        <input name="locality" type="text" value="{{ old('locality') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">City</label>
                        <input name="city" type="text" value="{{ old('city') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">District</label>
                        <input name="district" type="text" value="{{ old('district') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">State</label>
                        <input name="state" type="text" value="{{ old('state') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Pincode</label>
                        <input name="pincode" type="text" value="{{ old('pincode') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Country</label>
                        <input name="country" type="text" value="{{ old('country','India') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Latitude</label>
                        <input name="latitude" type="text" value="{{ old('latitude') }}" class="border p-2 rounded w-full">
                    </div>
                    <div>
                        <label class="block text-sm font-medium">Longitude</label>
                        <input name="longitude" type="text" value="{{ old('longitude') }}" class="border p-2 rounded w-full">
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-3">
                        ...
                        <input name="meta_description" type="text" value="{{ old('meta_description') }}" class="border p-2 rounded w-full">
                    </div>
                    <div class="md:col-span-3">
